...
1. [HacknDroid](https://github.com/RaffaDNDM/HacknDroid) - tool for Automation of some Mobile App Penetration Testing activities and interaction with the mobile Android device.
